        ...
        <div class="row">
            <div class="col-lg-12">
                <form action="{{route('envoisondage')}}" method="POST">
                    ...
                    <div class="custom-control custom-radio">
                        <input type="radio" id="HTC" name="MarqueCasqueUtilise" class="custom-control-input" value="{{$choice[9]->reponse}}">
                        <label class="custom-control-label" for="HTC" >{{$choice[9]->reponse}}</label>
                    </div>
                    <div class="custom-control custom-radio">
                        <input type="radio" id="Windows mixed" name="MarqueCasqueUtilise" class="custom-control-input" value="{{$choice[10]->reponse}}">
                        <label class="custom-control-label" for="Windows mixed">{{$choice[10]->reponse}}</label>
                    </div>
                    <div class="custom-control custom-radio">
                        <input type="radio" id="PSVR" name="MarqueCasqueUtilise" class="custom-control-input" value="{{$choice[11]->reponse}}">
